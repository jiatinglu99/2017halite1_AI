...
//Log 02/06/2017: Need to change the iterator limit value, also need to stop the small strength grids from attacking
public class GameMap{
    ...
    void setDirection(List<Pair> collection, int turn) {
        ...
        for (Pair temp : collection){
            if ((temp.mod == 4 & turn < 4)|(turn < length)) {
